...
CREATE TABLE "role_module_access_history" (
  "history_id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "access_id" bigint,
  "role_id" bigint,
  "module_id" bigint,
...
CREATE TABLE "user_system_roles_history" (
  "history_id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "user_role_id" bigint,
  "user_id" bigint,
  "system_id" bigint,
...
CREATE UNIQUE INDEX ON "users" ("username", "is_deleted");
...
CREATE INDEX ON "modules" ("parent_id");

CREATE INDEX ON "modules" ("grupo");

CREATE INDEX ON "modules" ("module_status");

CREATE INDEX ON "modules" ("order_index");

CREATE INDEX ON "modules" ("is_deleted");

CREATE INDEX ON "modules_history" ("module_id");

CREATE INDEX ON "modules_history" ("version");

CREATE INDEX ON "modules_history" ("change_type");

CREATE INDEX ON "modules_history" ("created_at");
...
CREATE INDEX ON "roles_history" ("role_id");

CREATE INDEX ON "roles_history" ("version");

CREATE INDEX ON "roles_history" ("created_at");

CREATE UNIQUE INDEX ON "role_module_access" ("role_id", "module_id", "is_deleted");

CREATE INDEX ON "role_module_access" ("role_id");

CREATE INDEX ON "role_module_access" ("module_id");

CREATE INDEX ON "role_module_access" ("has_access");

CREATE INDEX ON "role_module_access" ("is_deleted");

CREATE INDEX ON "role_module_access_history" ("access_id");

CREATE INDEX ON "role_module_access_history" ("role_id");

CREATE INDEX ON "role_module_access_history" ("module_id");

CREATE INDEX ON "role_module_access_history" ("created_at");

CREATE UNIQUE INDEX ON "user_system_roles" ("user_id", "system_id", "role_id", "is_deleted");

CREATE INDEX ON "user_system_roles" ("user_id");

CREATE INDEX ON "user_system_roles" ("system_id");

CREATE INDEX ON "user_system_roles" ("role_id");

CREATE INDEX ON "user_system_roles" ("assigned_by");

CREATE INDEX ON "user_system_roles" ("assignment_status");

CREATE INDEX ON "user_system_roles" ("effective_from");

CREATE INDEX ON "user_system_roles" ("effective_until");

CREATE INDEX ON "user_system_roles" ("is_deleted");

CREATE INDEX ON "user_system_roles_history" ("user_role_id");

CREATE INDEX ON "user_system_roles_history" ("user_id");

CREATE INDEX ON "user_system_roles_history" ("system_id");

CREATE INDEX ON "user_system_roles_history" ("role_id");

CREATE INDEX ON "user_system_roles_history" ("created_at");
...
COMMENT ON COLUMN "users"."full_name" IS 'Complete full name';
...
COMMENT ON TABLE "systems" IS 'Enhanced systems table with URL support for integrated access control.
Maintains full audit trail for public entity compliance.
';

COMMENT ON COLUMN "systems"."system_name" IS 'System display name';

COMMENT ON COLUMN "systems"."system_code" IS 'Short system code identifier';

COMMENT ON COLUMN "systems"."description" IS 'System description';

COMMENT ON COLUMN "systems"."url" IS 'System base URL';

COMMENT ON COLUMN "systems"."status" IS '1=active, 0=inactive';

COMMENT ON COLUMN "systems"."configuration_json" IS 'System configuration parameters';

COMMENT ON TABLE "modules" IS 'Enhanced modules table with hierarchical structure and grouping.
Supports complex menu structures and module organization.
Full audit trail for public entity compliance.
';

COMMENT ON COLUMN "modules"."system_id" IS 'System this module belongs to';

COMMENT ON COLUMN "modules"."grupo" IS 'Module group: Menu, Actions, Access, etc.';

COMMENT ON COLUMN "modules"."module_name" IS 'Module display name: Dashboard, Users, etc.';

COMMENT ON COLUMN "modules"."module_path" IS 'Module URL path: /dashboard, /dashboard/users, etc.';

COMMENT ON COLUMN "modules"."parent_id" IS 'Parent module for hierarchical structure';

COMMENT ON COLUMN "modules"."icon" IS 'Module icon identifier';

COMMENT ON COLUMN "modules"."order_index" IS 'Display order within same level';

COMMENT ON COLUMN "modules"."module_description" IS 'Module description';

COMMENT ON COLUMN "modules"."module_status" IS '1=active, 0=inactive';

COMMENT ON COLUMN "roles"."role_status" IS '1=active, 0=inactive';

COMMENT ON TABLE "role_module_access" IS 'Controls which modules each role can access.
Supports granular access control with access levels.
Implements logical deletion for audit compliance.
';

COMMENT ON COLUMN "role_module_access"."role_id" IS 'Role with access';

COMMENT ON COLUMN "role_module_access"."module_id" IS 'Module being accessed';

COMMENT ON COLUMN "role_module_access"."has_access" IS 'Access granted/denied flag';

COMMENT ON COLUMN "role_module_access"."access_level" IS 'read, write, admin, etc.';

COMMENT ON COLUMN "role_module_access"."granted_by" IS 'User who granted access';

COMMENT ON TABLE "user_system_roles" IS 'Enhanced user role assignments with temporal validity.
Links users to roles within specific systems.
Full audit trail for public entity compliance.
';

COMMENT ON COLUMN "user_system_roles"."user_id" IS 'User being assigned';

COMMENT ON COLUMN "user_system_roles"."system_id" IS 'System for the role';

COMMENT ON COLUMN "user_system_roles"."role_id" IS 'Role being assigned';

COMMENT ON COLUMN "user_system_roles"."assigned_at" IS 'When role was assigned';

COMMENT ON COLUMN "user_system_roles"."assigned_by" IS 'User who made the assignment';

COMMENT ON COLUMN "user_system_roles"."assignment_status" IS '1=active, 0=inactive';

COMMENT ON COLUMN "user_system_roles"."effective_from" IS 'Role effective start date';

COMMENT ON COLUMN "user_system_roles"."effective_until" IS 'Role expiration date (NULL = permanent)';
...
ALTER TABLE "modules" ADD FOREIGN KEY ("parent_id") REFERENCES "modules" ("module_id");
...
ALTER TABLE "modules_history" ADD FOREIGN KEY ("module_id") REFERENCES "modules" ("module_id");

ALTER TABLE "modules_history" ADD FOREIGN KEY ("created_by") REFERENCES "users" ("user_id");
...
ALTER TABLE "roles_history" ADD FOREIGN KEY ("role_id") REFERENCES "roles" ("role_id");

ALTER TABLE "roles_history" ADD FOREIGN KEY ("created_by") REFERENCES "users" ("user_id");

ALTER TABLE "role_module_access" ADD FOREIGN KEY ("role_id") REFERENCES "roles" ("role_id");

ALTER TABLE "role_module_access" ADD FOREIGN KEY ("module_id") REFERENCES "modules" ("module_id");

ALTER TABLE "role_module_access" ADD FOREIGN KEY ("granted_by") REFERENCES "users" ("user_id");

ALTER TABLE "role_module_access" ADD FOREIGN KEY ("deleted_by") REFERENCES "users" ("user_id");

ALTER TABLE "role_module_access_history" ADD FOREIGN KEY ("access_id") REFERENCES "role_module_access" ("access_id");

ALTER TABLE "role_module_access_history" ADD FOREIGN KEY ("created_by") REFERENCES "users" ("user_id");

ALTER TABLE "user_system_roles" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("user_id");

ALTER TABLE "user_system_roles" ADD FOREIGN KEY ("system_id") REFERENCES "systems" ("system_id");

ALTER TABLE "user_system_roles" ADD FOREIGN KEY ("role_id") REFERENCES "roles" ("role_id");

ALTER TABLE "user_system_roles" ADD FOREIGN KEY ("assigned_by") REFERENCES "users" ("user_id");

ALTER TABLE "user_system_roles" ADD FOREIGN KEY ("deleted_by") REFERENCES "users" ("user_id");

ALTER TABLE "user_system_roles_history" ADD FOREIGN KEY ("user_role_id") REFERENCES "user_system_roles" ("user_role_id");

ALTER TABLE "user_system_roles_history" ADD FOREIGN KEY ("created_by") REFERENCES "users" ("user_id");
