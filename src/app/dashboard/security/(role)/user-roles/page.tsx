                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) => setAssignmentForm({ ...assignmentForm, userId: value })}
                          >
                            <SelectTrigger>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            ...
                            <Input
                              ...
                              onChange={(e) => setAssignmentForm({ ...assignmentForm, expiresAt: e.target.value })}
                            />
                          </div>
                          <div>
                  ...
                  <Card key={user.id}>
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          <Badge className={getRiskBadge(user.riskLevel)}>
                            ...
                            {user.roles.map((role) => (
                              <div key={role.id} className="flex items-center justify-between p-3 border rounded-lg">
                                ...
                                <div className="flex items-center space-x-2">
                                  ...
                                  {role.expiresAt && (
                                    <Badge variant="destructive">Expira: {formatDate(role.expiresAt)}</Badge>
                                  )}
            ...
            <CardContent>
              <div className="space-y-4">
                {userRoles
                  ...
                  .map((assignment) => (
                    <div
                      key={`${assignment.userName}-${assignment.id}`}
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        {assignment.expiresAt && (
                          <Badge variant="destructive">Expira: {formatDate(assignment.expiresAt)}</Badge>
                        )}
                      ...
                      <div className="flex items-center space-x-2">
                        <div
                          className={`w-3 h-3 rounded-full ${
                            level === "admin" ? "bg-red-500" : level === "manager" ? "bg-orange-500" : "bg-blue-500"
                          }`}
                        ></div>
