...
func DownloadUbigeosTemplateHandler(c fiber.Ctx) error {
	file, err := services.GenerateUbigeosTemplateExcel()
	if err != nil {
	...
	filename := fmt.Sprintf("plantilla_ubigeos_%s.xlsx", time.Now().Format("20060102_150405"))
