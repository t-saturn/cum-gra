...
func BulkAssignRolesToUser(req dto.BulkAssignRolesToUserRequest, grantedBy uuid.UUID) (*dto.BulkAssignRolesToUserResponse, error) {
	db := config.DB
	...
	response := &dto.BulkAssignRolesToUserResponse{
		Created: 0,
		Skipped: 0,
		Failed:  0,
