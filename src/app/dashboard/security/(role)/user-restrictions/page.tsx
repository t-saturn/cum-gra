                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {user.violationCount > 0 && (
                            <Badge variant="destructive">{user.violationCount} violaciones</Badge>
                          )}
                          <Badge
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">
                            {user.violationCount} violaciones - Última:{" "}
                            {user.lastViolation ? formatDate(user.lastViolation) : "N/A"}
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center space-x-2">
                      ...
                      <div className="flex items-center space-x-2">
                        <div
                          className={`w-3 h-3 rounded-full ${
                            severity === "low" ? "bg-green-500" : severity === "medium" ? "bg-yellow-500" : "bg-red-500"
                          }`}
                        ></div>
                        <span className="capitalize">
