      ...
      <div className="min-h-screen bg-white flex flex-col lg:flex-row">
        ...
        <div className="hidden lg:flex w-full h-screen bg-gradient-to-br from-red-50 via-pink-50 to-red-100 relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            <svg
              className="absolute top-10 left-10 w-32 h-32 text-red-200 opacity-60"
              viewBox="0 0 100 100"
            >
              <path
            ...
            <svg
              className="absolute bottom-20 right-10 w-40 h-40 text-red-200 opacity-50"
              viewBox="0 0 100 100"
            >
              <circle cx="50" cy="50" r="40" fill="currentColor" />
            </svg>
            <svg
              className="absolute top-1/2 left-1/4 w-24 h-24 text-red-300 opacity-40"
              viewBox="0 0 100 100"
            >
                ...
                <form className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <a
                        href="#"
                        className="text-sm text-[#D90D1E] hover:text-[#B50A17]"
                      >
                  ...
                  <button
                    type="submit"
                    className="w-full h-12 bg-[#D90D1E] hover:bg-[#B50A17] text-white font-semibold rounded-lg transition-colors duration-200"
                  >
                    Iniciar sesión
                  </button>
