...
function Sidebar({
  ...
  return (
    <div
      className="group peer hidden md:block rounded-lg text-sidebar-foreground"
      data-state={state}
...
function SidebarMenuSkeleton({
  ...
  return (
    <div data-slot="sidebar-menu-skeleton" data-sidebar="menu-skeleton" className={cn('flex items-center gap-2 px-2 rounded-md h-8', className)} {...props}>
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<'ul'>) {
  return (
    <ul
      ...
      className={cn('flex flex-col gap-1 mx-3.5 px-2.5 py-0.5 border-sidebar-border border-l min-w-0 translate-x-px', 'group-data-[collapsible=icon]:hidden', className)}
      {...props}
    />
  );
}
