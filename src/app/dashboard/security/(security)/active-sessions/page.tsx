...
export default function ActiveSessionsManagement() {
  ...
  const filteredSessions = activeSessions.filter((session) => {
    ...
    const matchesDevice =
      deviceFilter === "all" || session.device.toLowerCase() === deviceFilter;
    const matchesRisk =
      riskFilter === "all" || session.riskLevel === riskFilter;
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    ¿Estás seguro de que quieres terminar la
                                    sesión de {session.userName}? Esta acción no
                                    se puede deshacer.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="w-24 bg-gray-200 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${
                              (sessionStats.byRisk.low / sessionStats.total) *
                              100
                            }%`,
                          }}
                        ></div>
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="w-24 bg-gray-200 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${
                              (sessionStats.byRisk.high / sessionStats.total) *
                              100
                            }%`,
                          }}
                        ></div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {activeSessions
                  .filter(
                    (s) => s.riskLevel === "high" || s.status === "warning"
                  )
                  .map((session) => (
                    <div
                      key={session.id}
